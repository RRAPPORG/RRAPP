...
public class Api {
	...
	@GetMapping("/user/get-all") //http://localhost:8080/api/user/get-all
	...
	@PostMapping(path="/user/post-user", consumes = {"application/json",}) //http://localhost:8080/api/user/post-user
